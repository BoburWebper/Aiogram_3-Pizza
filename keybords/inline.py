...
from aiogram.types import InlineKeyboardButton, InlineQuery, InlineKeyboardMarkup
...
def get_user_catalog_btns(*, level: int, categories: int, sizes: tuple[int] = (2,)):
    keyboard = InlineKeyboardBuilder()

    keyboard.add(InlineKeyboardButton(text="Back",
                                      callback_data=MenuCallBack(level=level - 1, menu_name='main').pack()))
    keyboard.add(InlineKeyboardButton(text="Savat 🛒",
